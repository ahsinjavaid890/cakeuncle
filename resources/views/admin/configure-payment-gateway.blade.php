                ...
                @switch($api_name)
                    ...
                    @break
                        ...
                        @case('toyyibpay')
                            ...
                            <div class="form-group">
                                <label for="Public Key">{{__('Category Key')}}</label>
                                <input type="text" name="public_key" value="{{$gateway->public_key ?? ''}}" class="form-control" id="public_key">
                                <input type="hidden" name="api_name" value="toyyibpay">
                            </div>

                            <div class="form-group">
                                <label for="Private Key">{{__('Secret Key')}}</label>
                                <input type="text" name="private_key" @if (!empty($gateway)) value="{{$gateway->private_key}}"@endif class="form-control" id="private-key">
                            </div>

                            <div class="form-group">
                                <label for="instruction">{{__('Payment Button Text')}}</label>
                                <input type="text" name="instruction" value="{{$gateway->instruction ?? 'Pay with toyyibPay'}}" class="form-control" id="instruction">
                            </div>
...
{{--                        <div class="form-group">--}}
{{--                            <label for="Public Key">{{__('PayS Key')}}</label>--}}
{{--                            <input type="text" name="public_key" value="{{$gateway->public_key ?? ''}}" class="form-control" id="public_key">--}}
{{--                            <input type="hidden" name="api_name" value="stripe">--}}
{{--                        </div>--}}
