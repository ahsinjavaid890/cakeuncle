    ...
    <div class="row">
        ...
        <div class=" col-md-4 ">
            <div class=" card card-body text-center">
                ...
                <a href="{{ url('configure-payment-gateway')}}?api_name=paypal" type="button" class="btn btn-info btn-sm mt-5">
        ...
        <div class=" col-md-4">
            <div class=" card card-body text-center">
                ...
                <a href="{{ url('configure-payment-gateway')}}?api_name=stripe" type="button" class="btn btn-info btn-sm mt-2">
        ...
        <div class=" col-md-4 ">
            <div class=" card card-body text-center">
                ...
                <a href="{{ url('configure-payment-gateway')}}?api_name=toyyibpay" type="button" class="btn btn-info btn-sm mt-5">
...
<h3 class="p-3">{{__('Bank Payment')}}</h3>
                ...
                <a href="{{ url('configure-payment-gateway')}}?api_name=bank" type="button" class="btn btn-info btn-md">
...
{{--                <a href="{{ url('configure-payment-gateway')}}?api_name=paystack" type="button" class="btn btn-info btn-md mt-3">--}}
