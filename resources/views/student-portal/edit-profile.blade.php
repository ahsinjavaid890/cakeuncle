                                            ...
                                            <div class="col-md-6 align-self-center">
                                                ...
                                                <select class="form-control " name="language" id="choices-language">
                                                    ...
                                                    @foreach($available_languages as $key => $value)
                                                        <option value="{{$key}}"
                                                                @if($student->language===$key) selected @endif >{{$value}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-6 align-self-center">
                                                <div class="">
                                                    ...
                                                    <select class="form-control" id="timezone" name="timezone">
                                                        ...
                                                        @foreach(\App\Supports\UtilSupport::timezoneList() as $key => $value)
                                                            <option value="{{$key}}" @if($student->timezone===$key) selected @endif >{{$value}}</option>
                                                        @endforeach
                                        ...
                                        <div class="text-center justify-content-center align-items-center p-4 p-sm-5 border border-2 border-dashed position-relative rounded-3">
                                            ...
                                            <div>
                                                ...
                                                <label style="cursor:pointer;">
													<span>
														<input class="form-control" type="file" name="photo" id="image" value="{{$student->photo?? old('photo') ?? ''}}" accept="image/gif, image/jpeg, image/png" />
													</span>
                                                </label>
