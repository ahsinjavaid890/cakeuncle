...
@section('title',$assignment_submission->title)
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <div class="card-body">
                    <div class="text-center">
                        <!-- Buttons -->
                        <a href="{{ url('public'}}/uploads/{{$assignment_submission->file}}" class="btn btn-success mb-sm-0 me-00 ">
            ...
            <form action="{{ url('save-assignment-mark')}}" method="post">
                <div class="card">
